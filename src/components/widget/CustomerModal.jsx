...
import CustomerSelectGrid from './CustomerSelectGrid';
...
class CustomerModal extends React.Component {
    ...
    handleSearch(e) {
        ...
        payload.customerCode = e.target.value;
        reqwest({
            url: '/swms/basicinfo/customer/getbycode',
            method: 'get',
