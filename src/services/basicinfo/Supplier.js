...
export async function create(params) {
  const url="/wms/basicinfo/supplier/savenew";
  return request(addTokenToUrl(url),createBase(params));
}

export async function get(params) {
  const url="/wms/basicinfo/supplier/get";
  return request(query(url,params));
}

export async function edit(params) {
  const url="/wms/basicinfo/supplier/savemodify";
  return request(addTokenToUrl(url),updateBase(params));
}

export async function remove(params) {
  const url=`/wms/basicinfo/supplier/remove?${qs.stringify(params)}`;
  return request(url,deleteBase(params));
}

export async function recover(params) {
  const url=`/wms/basicinfo/supplier/recover?${qs.stringify(params)}`;
