...
function AlcNtcBill({ location, dispatch, alcNtc }) {
  ...
  const batchProcessDeleteAlcNtcBillProps = {
    ...
    records: deleteAlcNtcBillEntitys || [],
    next: alcNtcBillNext,
    actionText: '删除',
    entityCaption: '配单',
    batchProcess(entity) {
  ...
  const batchProcessFinishAlcNtcBillProps = {
    ...
    records: finishAlcNtcBillEntitys || [],
    next: alcNtcBillNext,
    actionText: '完成',
    entityCaption: '配单',
    batchProcess(entity) {
  ...
  const batchProcessAbortAlcNtcBillProps = {
    ...
    records: abortAlcNtcBillEntitys || [],
    next: alcNtcBillNext,
    actionText: '作废',
    entityCaption: '配单',
    ...
    <div className="content-inner">
      {
                (() => {
                  switch (showPage) {
                    ...
                    case 'create':
                      return <div><AlcNtcBillCreateForm {...alcNtcBillCreateFormProps} /></div>;
                    default: {
                      return (
                        <div>
